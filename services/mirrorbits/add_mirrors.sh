...
mirrorbits add -http=https://ftp-chi.osuosl.org/pub/msys2/ -rsync=rsync://rsync.osuosl.org/msys2/ ftp-chi.osuosl.org
mirrorbits enable ftp-chi.osuosl.org

mirrorbits add -http=https://ftp-nyc.osuosl.org/pub/msys2/ -rsync=rsync://rsync.osuosl.org/msys2/ ftp-nyc.osuosl.org
mirrorbits enable ftp-nyc.osuosl.org

mirrorbits add -http=https://ftp-osl.osuosl.org/pub/msys2/ -rsync=rsync://rsync.osuosl.org/msys2/ ftp-osl.osuosl.org
